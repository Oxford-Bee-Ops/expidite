...
class RpiCore:
    ...
    def configure(self, fleet_config: list[DeviceCfg]) -> None:
        ...
        logger.info(f"NICKB-CONFIG-005")
        root_cfg.set_inventory(fleet_config)
        logger.info(f"NICKB-CONFIG-006")
